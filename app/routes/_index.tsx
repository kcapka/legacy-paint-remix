...
export default function Index() {
  ...
  return (
    <div className="min-h-[100svh]">
        ...
        <HeroFadeIn>
          <div className="custom-blur inline-block p-5 md:p-8 shadow-xl max-w-[700px]">
            ...
            <div className="flex justify-center">
              <Link to="/services">
                <button className="p-5 bg-button text-white md:text-xl hover:bg-[#888683] duration-300 shadow-inner">
                  Our Services
                </button>
              </Link>
            </div>
      ...
      <section className="flex flex-col md:flex-row bg-dark text-white default-px default-py">
        ...
        <div className="flex-1 md:pr-32">
          ...
          <div className="flex justify-center md:justify-start">
            <p className="p-5 bg-button text-white md:text-xl hover:bg-[#888683] duration-300 inline-block cursor-pointer">
              Schedule Contactless Quote
            </p>
          </div>
        </div>
      </section>
      <motion.section
        className="default-px bg-light default-py"
        variants={container}
        initial="hidden"
        whileInView="show"
        viewport={{ once: true }}
      >
        <h1 className="text-4xl mb-8 md:mb-12 text-center md:text-start">
          Our Services
        </h1>
        <div className="[&_div]:md:pr-5 [&_div]:mb-16 [&_div]:md:mb-0 [&_div]:max-w-[400px] flex flex-col md:flex-row md:justify-between [&_h1]:text-xl [&_img]:mb-5 [&_h1]:mb-3 [&_img]:mx-auto [&_h1]:font-bold [&_h1]:px-2 [&_p]:px-2 [&_p]:text-base [&_p]:md:text-lg mb-10 md:mb-20">
          <motion.div
            className="flex-1 opacity-0 translate-y-20"
            variants={item}
          >
