            ...
            <section className='default-px default-py'>
                <div className='flex flex-col md:flex-row md:justify-between'>
                    ...
                    initial={{x: -100, opacity: 0}} whileInView={{x: 0, opacity: 1}} transition={{duration: 1}} viewport={{once: true}}>
                        <h2 className='text-2xl font-bold mb-5 md:mb-10'>Schedule A Free Consultation</h2>
                    ...
                    initial={{x: 100, opacity: 0}} whileInView={{x: 0, opacity: 1}} transition={{duration: 1}} viewport={{once: true}}>
                        <h2 className='text-2xl font-bold mb-5 md:mb-10'>Request A Contactless Quote</h2>
